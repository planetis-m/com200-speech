...
**Core message:**
This is not weak democracy.
This is **oligarchy** using democratic language.
...
**Transition:**
First, break the illusion of the ballot by itself.
...
initiate laws,
recall officials,
or audit power after election day,

then they are not ruling.

They are authorizing representatives who govern.
...
**Core message:**
Oligarchy reproduces itself through **access**.
...
**Core message:**
The solution is constitutional **authority** for the people.
...
**Transition:**
That creates two different political orders.
...
**Core message:**
Do not settle for representation
without **power**.
